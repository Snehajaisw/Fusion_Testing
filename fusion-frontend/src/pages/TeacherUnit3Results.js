...
export default function TeacherUnit3Results() {
  ...
  axios.get("https://fusion-testingphase1.onrender.com/api/assignments/performance", {
    params: {
      unit: 3,
      teacherId,
      section
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "ES_Practical_Quiz_Results.xlsx");
  };
  ...
  doc.text("ES Practical Quiz Results", 14, 15);
  ...
  <div className="learn-container">
    ...
    <div className="glass-card" style={{ background: "#0f1e35", padding: "25px", width: "80%", margin: "auto" }}>
      
      <h1 className="dashboard-title" style={{ textAlign: "center", color: "#fff" }}>
        📊 ES Practical Quiz Results
      </h1>
